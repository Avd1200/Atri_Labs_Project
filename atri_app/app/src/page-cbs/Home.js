...
export function useNavTextBox1Cb() {
	const onClick = useCallback(callbackFactory("NavTextBox1", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useMainContentCb() {
	const onClick = useCallback(callbackFactory("MainContent", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
